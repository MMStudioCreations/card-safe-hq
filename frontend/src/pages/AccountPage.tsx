                          ...
                          <div
                            ...
                            style={{
                              background: level <= strength
                                ? strength <= 1 ? '#ef4444' : strength <= 2 ? '#f59e0b' : strength <= 3 ? '#22c55e' : '#00E5FF'
          ...
          {activeSection === 'billing' && (
            <div className="glass rounded-[var(--radius-lg)] p-6 space-y-6">
              ...
              <div className="rounded-[var(--radius-md)] p-4 space-y-3"
                style={{
                  background: isOwner
                    ? 'linear-gradient(135deg, rgba(201,168,76,0.1), rgba(0,229,255,0.05))'
                    : isPro
                    ? plan === 'yearly'
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    {isOwner ? (
                      ...
                      <Crown className="h-5 w-5" style={{ color: plan === 'yearly' ? '#C9A84C' : '#00E5FF' }} />
                    ) : (
                  ...
                  <span className="text-sm font-bold" style={{ color: isOwner ? '#C9A84C' : isPro ? (plan === 'yearly' ? '#C9A84C' : '#00E5FF') : 'var(--cv-muted)' }}>
                ...
                <div className="grid grid-cols-1 gap-1.5 sm:grid-cols-2">
                  {[
                    ...
                    <div key={f.label} className={`flex items-center gap-2 text-xs ${f.included ? 'text-cv-text' : 'text-cv-muted'}`}>
                      <div className={`h-1.5 w-1.5 rounded-full shrink-0 ${f.included ? 'bg-[#00E5FF]' : 'bg-white/20'}`} />
                      {f.label}
                    </div>
                  ))}
                </div>
